class DashboardController < ApplicationController
  def index
    @last_7_days = {"New Users" => User.user_count(7),
                    ...
                    "Average Order Value" => OrderContent.avg_order_value(7),
                    "Largest Order Value" => OrderContent.largest_order_value(7)}
    @last_30_days = {"New Users" => User.user_count(30),
                      ...
                      "Average Order Value" => OrderContent.avg_order_value(30),
                      "Largest Order Value" => OrderContent.largest_order_value(30)}
    @total =        {"New Users" => User.user_count,
                      ...
                      "Average Order Value" => OrderContent.avg_order_value,
                      "Largest Order Value" => OrderContent.largest_order_value}
