class Address < ActiveRecord::Base
  ...
  has_many :default_billing_addresses, :class_name => "User", :foreign_key => :billing_id, :dependent => :nullify
  has_many :default_shipping_addresses, :class_name => "User", :foreign_key => :shipping_id, :dependent => :nullify
