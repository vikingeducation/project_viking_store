class User < ApplicationRecord
  ...
  def self.highest_single_order
    ...
    ['Highest Single Order', u.first_name + ' '  + u.last_name, "$#{u.amount.round}" ]
  end
  ...
  def self.highest_lifetime_order
    ...
    ['Highest Lifetime Order', u.first_name + ' ' + u.last_name, "$#{u.amount.round}"]
  end
  ...
  def self.highest_average_order
    ...
    ['Highest Average Order', u.first_name + ' '  + u.last_name, "$#{u.total.round}" ]
  end
